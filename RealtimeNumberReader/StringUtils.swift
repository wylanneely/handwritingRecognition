...
extension String {
    ...
    func extractTextData() -> (Range<String.Index>,
                               String)? {
        let pattern = #"""
        ...
        do {
            ...
            if let match = regex.firstMatch(in: substring, options: [], range: nsrange) {
                for rangeInd in 1 ..< match.numberOfRanges {
                    ...
                    textCharacterString += matchString as String
                }
            }
        } catch {
        ...
        //let allowedChars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQURTUVWXYZ"
        
        var result = ""

        for char in textCharacterString {
            print("written word: \(char)")
